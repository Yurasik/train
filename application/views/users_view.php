<div class="container">
    <div class="col-sm-6 col-sm-offset-3  users-form-box">
        <form action="" class="navbar-form" method="post">
            ...
            <div class="clear"></div>
            <a href="users/register" class="pull-right">
                <i class="fa fa-user"></i>
                Регистрация
            </a>
            <div class="clear"></div>
            <p id="authorization_info"><?php if(isset($_SESSION['authorization_info'])) echo $_SESSION['authorization_info']; unset($_SESSION['authorization_info']) ?></p>
        </form>
    </div>
</div>